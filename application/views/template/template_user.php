    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <img src="<?php echo base_url(); ?>public/plugins/adminlte/img/logobig.png" width="50" height="45"/>
            </div>
            <div class="navbar-custom-menu">
              <ul class="nav navbar-nav">
                <img src="<?php echo base_url(); ?>public/images/unista.png" width="130" height="50"/>
              </ul>
            </div>
          </div><!-- /.container-fluid -->
        </nav>
      ...
      <footer class="main-footer no-print">
        ...
        <div class="container">
          ...
          <strong> <a href="<?php echo site_url(); ?>/manager/" >Login Administrator</a></strong>
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
