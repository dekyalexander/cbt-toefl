    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-mini"><b>TOEFL</b></span>
      ...
      <footer class="main-footer">
        ...
        <strong>Tugas akhir skripsi 2018&copy;Deky alexander</strong>
      </footer>
		...
		<div class="modal-dialog">
			<div class="modal-content">
						...
						<?php echo form_open('manager/dashboard/password','id="form-password"')?>
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password-old" name="password-old" placeholder="Masukan password lama">
                                </div>
                                <div class="form-group">
                                    <label>Password baru</label>
                                    <input type="password" class="form-control" id="password-new" name="password-new" placeholder="Masukan password baru">
                                </div>
                                <div class="form-group">
                                    <label>Konfirmasi password</label>
                                    <input type="password" class="form-control" id="password-confirm" name="password-confirm" placeholder="Masukan konfirmasi password baru">
                                </div>
                            </div>
                        <?php echo form_close(); ?>   
				</div>
				<div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="password-submit">Simpan</button>
				</div>
			</div><!-- /.modal-content -->
		</div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
