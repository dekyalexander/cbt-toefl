        ...
        <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
    						<div class="box-title">Daftar Status</div>
    						<div class="box-tools pull-right">
    							<div class="dropdown pull-right">
    								<a style="cursor: pointer;" onclick="tambah()">Tambah Status</a>
    							</div>
    						</div>
                    </div><!-- /.box-header -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="trx-judul">Tambah Status</div>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-group" name="tambah-group" autocomplete="off" placeholder="Masukkan Status">
                            </div>
    ...
    <?php echo form_open($url.'/edit','id="form-edit"'); ?>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                    <div id="trx-judul">Edit Status</div>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
