                ...
                <div class="box-body">
                    <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" name="tambah-nama" id="tambah-nama" autocomplete="off" class="form-control input-sm" />
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tambah-poin" id="tambah-poin" autocomplete="off" class="form-control input-sm"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Jawaban Salah</label>
                            <div class="col-sm-9">
                                <input type="text" name="tambah-poin-salah" id="tambah-poin-salah" autocomplete="off" class="form-control input-sm"  />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tambah-poin-kosong" id="tambah-poin-kosong" autocomplete="off" class="form-control input-sm"  />
